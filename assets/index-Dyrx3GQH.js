...
function J() {
  if (N) return n;
  N = 1;
  var E = /* @__PURE__ */ Symbol.for("react.transitional.element"), I = /* @__PURE__ */ Symbol.for("react.portal"), M = /* @__PURE__ */ Symbol.for("react.fragment"), x = /* @__PURE__ */ Symbol.for("react.strict_mode"), L = /* @__PURE__ */ Symbol.for("react.profiler"), k = /* @__PURE__ */ Symbol.for("react.consumer"), U = /* @__PURE__ */ Symbol.for("react.context"), q = /* @__PURE__ */ Symbol.for("react.forward_ref"), b = /* @__PURE__ */ Symbol.for("react.suspense"), D = /* @__PURE__ */ Symbol.for("react.memo"), d = /* @__PURE__ */ Symbol.for("react.lazy"), z = /* @__PURE__ */ Symbol.for("react.activity"), S = Symbol.iterator;
  function G(t) {
  ...
  v.constructor = y, w(v, a.prototype), v.isPureReactComponent = true;
  var O = Array.isArray;
  function R() {
  }
  ...
  function W(t) {
    switch (t.status) {
      ...
      case "rejected":
        throw t.reason;
      default:
        switch (typeof t.status == "string" ? t.then(R, R) : (t.status = "pending", t.then(function(e) {
  ...
  function _(t, e, u, r, o) {
    ...
    if (i) return o = o(t), i = r === "" ? "." + C(t, 0) : r, O(o) ? (u = "", i != null && (u = i.replace(j, "$&/") + "/"), _(o, e, u, "", function(Z) {
      return Z;
    })) : o != null && (m(o) && (o = K(o, u + (o.key == null || t && t.key === o.key ? "" : ("" + o.key).replace(j, "$&/") + "/") + i)), e.push(o)), 1;
    i = 0;
    var p = r === "" ? "." : r + ":";
    if (O(t)) for (var c = 0; c < t.length; c++) r = t[c], s = p + C(r, c), i += _(r, e, u, s, o);
    else if (c = G(t), typeof c == "function") for (t = c.call(t), c = 0; !(r = t.next()).done; ) r = r.value, s = p + C(r, c++), i += _(r, e, u, s, o);
    else if (s === "object") {
  ...
  var $ = typeof reportError == "function" ? reportError : function(t) {
    ...
    console.error(t);
  }, X = { map: l, forEach: function(t, e, u) {
    l(t, function() {
  ...
  return n.Activity = z, n.Children = X, n.Component = a, n.Fragment = M, n.Profiler = L, n.PureComponent = y, n.StrictMode = x, n.Suspense = b, n.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE = f, n.__COMPILER_RUNTIME = { __proto__: null, c: function(t) {
    ...
    if (e != null) for (s in e.key !== void 0 && (o = "" + e.key), e) !P.call(e, s) || s === "key" || s === "__self" || s === "__source" || s === "ref" && e.ref === void 0 || (r[s] = e[s]);
    ...
    return t = { $$typeof: U, _currentValue: t, _currentValue2: t, _threadCount: 0, Provider: null, Consumer: null }, t.Provider = t, t.Consumer = { $$typeof: k, _context: t }, t;
  }, n.createElement = function(t, e, u) {
    var r, o = {}, s = null;
    if (e != null) for (r in e.key !== void 0 && (s = "" + e.key), e) P.call(e, r) && r !== "key" && r !== "__self" && r !== "__source" && (o[r] = e[r]);
