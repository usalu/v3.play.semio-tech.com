...
import { a as rn, g as nn } from "./_commonjsHelpers-CE1G-McA.js";
...
var ir;
function un() {
  return ir || (ir = 1, (function(Q, Ue) {
    var $ = void 0, B = function(C) {
      return $ || ($ = new Promise(function(se, sr) {
        var W = typeof C < "u" ? C : {}, ct = W.onAbort;
        W.onAbort = function(e) {
          sr(new Error(e)), ct && ct(e);
        }, W.postRun = W.postRun || [], W.postRun.push(function() {
          se(W);
        }), Q = void 0;
        var o;
        o || (o = typeof W < "u" ? W : {});
        var ur = typeof window == "object", De = typeof WorkerGlobalScope < "u", we = typeof process == "object" && typeof process.versions == "object" && typeof process.versions.node == "string" && process.type != "renderer";
        o.onRuntimeInitialized = function() {
          ...
          function i(s) {
            if (this.filename = "dbfile_" + (4294967295 * Math.random() >>> 0), s != null) {
              ...
              if (h && (h = typeof h == "string" ? h : Ge(h), p = f ? Ve(h + "/" + f) : h), f = Nt(true, true), p = qr(p, f), s) {
                if (typeof s == "string") {
                  h = Array(s.length);
          ...
          var u = Y(4), a = o.cwrap, m = a("sqlite3_open", "number", ["string", "number"]), _ = a("sqlite3_close_v2", "number", ["number"]), b = a("sqlite3_exec", "number", ["number", "string", "number", "number", "number"]), A = a("sqlite3_changes", "number", ["number"]), x = a("sqlite3_prepare_v2", "number", ["number", "string", "number", "number", "number"]), Xt = a("sqlite3_sql", "string", ["number"]), xr = a("sqlite3_normalized_sql", "string", ["number"]), Yt = a("sqlite3_prepare_v2", "number", ["number", "number", "number", "number", "number"]), Or = a("sqlite3_bind_text", "number", ["number", "number", "number", "number", "number"]), Gt = a("sqlite3_bind_blob", "number", ["number", "number", "number", "number", "number"]), Rr = a("sqlite3_bind_double", "number", ["number", "number", "number"]), Lr = a("sqlite3_bind_int", "number", ["number", "number", "number"]), Pr = a("sqlite3_bind_parameter_index", "number", ["number", "string"]), Tr = a("sqlite3_step", "number", ["number"]), Ur = a("sqlite3_errmsg", "string", ["number"]), Dr = a("sqlite3_column_count", "number", ["number"]), Wr = a("sqlite3_data_count", "number", ["number"]), jr = a("sqlite3_column_double", "number", ["number", "number"]), Zt = a("sqlite3_column_text", "string", ["number", "number"]), zr = a("sqlite3_column_blob", "number", ["number", "number"]), Fr = a("sqlite3_column_bytes", "number", ["number", "number"]), Ir = a("sqlite3_column_type", "number", ["number", "number"]), Qr = a("sqlite3_column_name", "string", ["number", "number"]), $r = a("sqlite3_reset", "number", ["number"]), Br = a("sqlite3_clear_bindings", "number", ["number"]), Cr = a("sqlite3_finalize", "number", ["number"]), Kt = a("sqlite3_create_function_v2", "number", "number string number number number number number number number".split(" ")), Hr = a("sqlite3_value_type", "number", ["number"]), Vr = a("sqlite3_value_bytes", "number", ["number"]), Xr = a("sqlite3_value_text", "string", ["number"]), Yr = a("sqlite3_value_blob", "number", ["number"]), Gr = a("sqlite3_value_double", "number", ["number"]), Zr = a("sqlite3_result_double", "", ["number", "number"]), Jt = a("sqlite3_result_null", "", ["number"]), Kr = a("sqlite3_result_text", "", ["number", "string", "number", "number"]), Jr = a("sqlite3_result_blob", "", ["number", "number", "number", "number"]), en = a("sqlite3_result_int", "", ["number", "number"]), Te = a("sqlite3_result_error", "", ["number", "string", "number"]), er = a("sqlite3_aggregate_context", "number", ["number", "number"]), tr = a("RegisterExtensionFunctions", "number", ["number"]), rr = a("sqlite3_update_hook", "number", ["number", "number", "number"]);
          r.prototype.bind = function(s) {
            ...
            return s == null && (s = this.Oa, this.Oa += 1), jr(this.Qa, s);
            ...
            for (var h = Wr(this.Qa), p = 0; p < h; p += 1) switch (Ir(this.Qa, p)) {
              case 1:
            ...
            for (var s = [], f = Dr(this.Qa), h = 0; h < f; h += 1) s.push(Qr(this.Qa, h));
            return s;
            ...
            var h = Le(s, Re);
            this.lb.push(h), this.db.handleError(Or(this.Qa, f, h, s.length - 1, 0));
            ...
            f == null && (f = this.Oa, this.Oa += 1), this.db.handleError((s === (s | 0) ? Lr : Rr)(this.Qa, f, s));
            ...
            return this.freemem(), Br(this.Qa) === 0 && $r(this.Qa) === 0;
        ...
        } else (ur || De) && (De ? j = self.location.href : typeof document < "u" && document.currentScript && (j = document.currentScript.src), j = j.startsWith("blob:") ? "" : j.slice(0, j.replace(/[?#].*/, "").lastIndexOf("/") + 1), De && (_e = (e) => {
        ...
        function kt(e, t) {
          At[e] = { input: [], output: [], cb: t }, et(e, pr);
        }
        var pr = { open(e) {
...
`));
        ...
        }, Ye = null, Mt = {}, ne = [], br = 1, H = null, St = false, xt = true, Ot = {}, l = class {
          constructor(e) {
          ...
          constructor(e, t, r, n) {
            ...
            e || (e = this), this.parent = e, this.Xa = e.Xa, this.id = br++, this.name = t, this.mode = r, this.rdev = n, this.atime = this.mtime = this.ctime = Date.now();
          }
          get read() {
        ...
        function Rt(e, t, r, n) {
          return e = new yr(e, t, r, n), t = Ze(e.parent.id, e.name), e.bb = H[t], H[t] = e;
        }
        function S(e) {
        ...
        function Ut(e, t = -1) {
          if (e = Object.assign(new _r(), e), t == -1) e: {
        ...
        var xe = void 0, Oe = () => {
          var e = g[+xe >> 2];
          return xe += 4, e;
        }, nt = 0, Ar = [0, 31, 60, 91, 121, 152, 182, 213, 244, 274, 305, 335], kr = [0, 31, 59, 90, 120, 151, 181, 212, 243, 273, 304, 334], ce = {}, Bt = (e) => {
          var _a;
        ...
        H = Array(4096), Dt(w, "/"), D("/tmp"), D("/home"), D("/home/web_user"), (function() {
          D("/dev"), et(259, { read: () => 0, write: (n, i, u, a) => a, Va: () => 0 }), Ne("/dev/null", 259), kt(1280, dr), kt(1536, wr), Ne("/dev/tty", 1280), Ne("/dev/tty1", 1536);
        ...
        var Sr = { a: (e, t, r, n) => re(`Assertion failed: ${e ? E(y, e) : ""}, at: ` + [t ? t ? E(y, t) : "" : "unknown filename", r, n ? n ? E(y, n) : "" : "unknown function"]), i: function(e, t) {
          try {
          ...
          var r = e.getFullYear();
          g[t + 28 >> 2] = (r % 4 !== 0 || r % 100 === 0 && r % 400 !== 0 ? kr : Ar)[e.getMonth()] + e.getDate() - 1 | 0, g[t + 36 >> 2] = -(60 * e.getTimezoneOffset()), r = new Date(e.getFullYear(), 6, 1).getTimezoneOffset();
          ...
          var r = setTimeout(() => {
            delete ce[e], Nr(() => Vt(e, performance.now()));
          }, t);
        ...
        (async function() {
          ...
          }) : ($e ?? ($e = o.locateFile ? o.locateFile("sql-wasm.wasm", j) : j + "sql-wasm.wasm"), e((await lr(t)).instance));
        ...
        o.stackSave = () => de(), o.stackRestore = (e) => pe(e), o.stackAlloc = (e) => Y(e), o.cwrap = (e, t, r, n) => {
          ...
          return t !== "string" && i && !n ? o["_" + e] : (...u) => Mr(e, t, r, u);
        ...
        function ft() {
          ...
          if (0 < G) ae = ft;
            ...
            if (o.preRun) for (typeof o.preRun == "function" && (o.preRun = [o.preRun]); o.preRun.length; ) hr();
...
var or = un();
const an = nn(or), hn = sn({ __proto__: null, default: an }, [or]);
export {
  hn as s
};
